...
export default function MyTicketsPage() {
  ...
  const handleConfirmResale = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from("resales").insert([
        {
      ...
      alert(error instanceof Error ? error.message : "Failed to list ticket.");
    } finally {
      setListing(false);
    }
  };
        ...
        {loading ? (
          ...
          <div className="grid gap-6">
            {tickets.map((ticket) => {
              ...
              const buyerTotal = getBuyerTotal(originalPrice);
              const alreadyListed = ticket.resale?.status === "active";
  ...
  Swift Resale
            ...
            <p className="mt-4 text-sm leading-6 text-white/70">
              Are you sure you want to list this ticket for resale?
            </p>
            ...
            <div className="mt-6 flex gap-3">
              <button
                ...
                className="flex-1 border border-white/20 px-4 py-3 text-sm font-bold text-white"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="flex-1 bg-white px-4 py-3 text-sm font-bold text-black disabled:opacity-60"
              >
