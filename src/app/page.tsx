  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="relative min-h-screen w-full overflow-hidden bg-black">
        ...
        <div className="relative z-20 flex min-h-[70vh] flex-col items-center justify-start px-6 pt-16 text-center">
          <h1 className="max-w-5xl text-[42px] font-extrabold leading-[0.95] tracking-tight sm:text-[56px] md:text-[72px] lg:text-[86px]">
            Where the world meets
          </h1>

          <p className="mt-2 text-[11px] uppercase tracking-[0.35em] text-white/80 sm:text-[12px] md:text-[13px]">
            For the people, by the people
          </p>

          <div className="mt-6 flex w-full max-w-[780px] items-center gap-3 rounded-sm bg-white px-5 py-3 text-black shadow-[0_12px_40px_rgba(0,0,0,0.35)] transition hover:shadow-[0_18px_60px_rgba(0,0,0,0.45)]">
            ...
            <div className="relative w-full text-left">
              ...
              {!searchValue && (
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center overflow-hidden whitespace-nowrap">
                  <span className="text-[16px] font-bold tracking-[-0.02em] text-black">
                    {typedPrompt}
                    {!typingComplete && (
                  ...
                  {typingComplete && (
                    <span
                      className={`ml-3 text-[16px] italic font-medium tracking-[-0.01em] text-black/55 transition-all duration-500 ${
                        isSuggestionVisible
            ...
            <button className="rounded-sm bg-black px-5 py-2.5 text-sm font-medium text-white transition hover:bg-black/80 md:px-6">
              Search
            </button>
          </div>
        </div>
      ...
      <div className="relative z-20 mx-auto max-w-[1300px] -mt-24 px-6 pt-4 pb-12">
        <section className="mb-16">
          <div className="mb-6 flex items-center justify-between">
            ...
            <Link
              href="/events"
              className="text-sm text-white/70 transition hover:text-white hover:underline underline-offset-4"
            >
              View all →
            </Link>
          </div>
      ...
      <footer className="mt-16 border-t border-white/10 bg-black animate-fade-in">
        <div className="mx-auto flex max-w-[1300px] flex-col gap-10 px-6 py-10 md:flex-row md:items-start md:justify-between">
          ...
          <div className="flex flex-col gap-5 md:items-end">
            ...
            <button className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-white/70 transition hover:bg-white/10 hover:text-white">
              <span>English</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto flex max-w-[1300px] flex-col gap-3 px-6 py-4 text-xs text-white/35 md:flex-row md:items-center md:justify-between">
